...
class UNet(object):
    ...
    def gaussion_encoder(self, images, is_training, reuse=False):
        with tf.variable_scope("gaussion_encoders"):
            ...
            e1 = conv2d(images, self.generator_dim, scope="gaussion_e1")
    ...
    def build_model(self, is_training=True, inst_norm=False, no_target_source=False):
        ...
        T_loss =  tf.reduce_sum(l1_loss +const_loss+kl_loss)
        ...
        All_merged_summary = tf.summary.merge([l1_loss_summary,T_loss_summary,kl_loss_summary,const_loss_summary])
