...
class UNet(object):
    ...
    def build_model(self, is_training=True, inst_norm=False, no_target_source=False):
        ...
        fake_target_shuffle2, target_gaussian1_shuffle2, target_gaussian2_shuffle2= self.generator_gaussian(layers_source,real_A_shuffle2,embedding_ids,is_training=is_training,inst_norm=inst_norm,reuse=True)

        real_A_shuffle3 = tf.random_shuffle(real_A_shuffle2)
        fake_target_shuffle3, target_gaussian1_shuffle3, target_gaussian2_shuffle3= self.generator_gaussian(layers_source,real_A_shuffle3, embedding_ids,is_training=is_training,inst_norm=inst_norm,reuse=True)

        real_A_shuffle4 = tf.random_shuffle(real_A_shuffle3)
        fake_target_shuffle4, target_gaussian1_shuffle4, target_gaussian2_shuffle4= self.generator_gaussian(layers_source,
                                                                                                          real_A_shuffle4,
                                                                                                          embedding_ids,
        ...
        fake_target_shuffle5, target_gaussian1_shuffle5, target_gaussian2_shuffle5= self.generator_gaussian(layers_source,
                                                                                                          real_A_shuffle5,
                                                                                                          embedding_ids,
                                                                                                          is_training=is_training,
                                                                                                          inst_norm=inst_norm,
